...
--TABLA #1 
--CREACIÓN DE UNA TABLA QUE CONTIENE LOS ATRIBUTOS V_id_estado Y V_descripcion, SIENDO V_id_estado LA LLAVE PRIMARIA Y V_descripcion VARCHAR2
...
--TABLA #2 
--CREACIÓN DE UNA TABLA QUE CONTIENE LOS ATRIBUTOS V_id_categoria  Y V_nombre_categoria, SIENDO V_id_categoria LA LLAVE PRIMARIA Y V_nombre_categoria VARCHAR2
...
--TABLA #3 
--CREACIÓN DE UNA TABLA QUE CONTIENE LOS ATRIBUTOS V_id_producto, V_id_categoria,V_id_estado,V_nombre_producto,V_descripcion_producto, V_precio Y 
...
--TABLA #4 
--CREACIÓN DE UNA TABLA QUE CONTIENE LOS ATRIBUTOS V_id_cliente INT PRIMARY KEY,V_nombre_cliente), V_apellido_cliente VARCHAR2(255),V_email, V_telefono,
...
--CREADO POR NICOLE Hidalgo
--FECHA 20/07/2024
--CREACION DE UNA TABLA PARA DESCRIPICIONES DONDE SU LLAVE PRIMARIA VA SER  V_id_descripcion
--TABLA #5 
--CREACIÓN DE UNA TABLA QUE CONTIENE LOS ATRIBUTOS  V_id_descripcion Y V_descripcion, SIENDO V_id_estado LA LLAVE PRIMARIA Y V_descripcion VARCHAR2
